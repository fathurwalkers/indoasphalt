...
<body class="index-page">
    ...
    <main class="main">
        ...
        <section id="hero" class="hero section dark-background">
            ...
            <img src="{{ asset('assets/logis') }}/assets/img/world-dotted-map.png" alt="" class="hero-bg"
                data-aos="fade-in">
            ...
            <div class="container">
                <div class="row gy-2 d-flex justify-content-between">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                        <img src="{{ asset('assets/logis') }}/assets/img/banner-test2.png"
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 position-relative align-self-start order-lg-last order-first"
                        ...
                        <img src="{{ asset('assets/logis') }}/assets/img/about.jpg" class="img-fluid"
                            alt="">
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('assets/logis') }}/assets/img/service-1.jpg" alt=""
                                    class="img-fluid">
                            </div>
                            <h3>Storage</h3>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('assets/logis') }}/assets/img/service-2.jpg" alt=""
                                    class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('assets/logis') }}/assets/img/service-3.jpg" alt=""
                                    class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('assets/logis') }}/assets/img/service-4.jpg" alt=""
                                    class="img-fluid">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('assets/logis') }}/assets/img/service-5.jpg" alt=""
                                    class="img-fluid">
                            </div>
                            <h3>Packaging</h3>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                        <div class="card">
                            <div class="card-img">
                                <img src="{{ asset('assets/logis') }}/assets/img/service-6.jpg" alt=""
                                    class="img-fluid">
                            </div>
        ...
        <section id="testimonials" class="testimonials section dark-background">
            ...
            <img src="{{ asset('assets/logis') }}/assets/img/testimonials-bg.jpg" class="testimonials-bg"
                alt="">
